...
public class Digraph implements IGraph {
    ...
    public Digraph(Digraph digraph) {
        ...
        for (int i = 0; i < digraph.V(); i++) {
            this.GV[i] = new Node(digraph.GV[i].getName());
            for (Edge edge : digraph.getAjd(i)) {
                this.addEdge(edge.getNode1().getName(), edge.getNode2().getName(), edge.getWeight());
            }
        }
    }
